# "Políticas de Segurança" Class Exercises Repository
...
<br>
<br>
Welcome to the "Políticas de Segurança" exercises repository!

<h2>Overview</h2>
    This repository contains all the exercises completed during a class about security policies, which is part of the Network Administration and Cybersecurity course at CESAE (Centro para Desenvolvimento das Competências Digitais).
    The course was in Portuguese so the content of this repository will be aswell.

<h2>About the Course</h2> 
    This class focused on various topics such as physical network security, preventive data security, active security systems (implementation of ACLs and content filtering), firewalls, load balancing.
